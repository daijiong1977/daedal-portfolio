        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5 text-sm">
            <a
              ...
              className="text-[var(--muted)] hover:text-[var(--foreground)] transition-colors no-underline flex items-center gap-1.5"
            >
            ...
            <a
              href="https://twitter.com/daedaldai"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[var(--muted)] hover:text-[var(--foreground)] transition-colors no-underline flex items-center gap-1.5"
            >
