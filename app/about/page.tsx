    ...
    <div className="max-w-2xl">
      ...
      <div className="space-y-8 text-[var(--foreground)]/90 leading-relaxed">
        <section className="space-y-4">
          ...
          <p>
            I&apos;ve been writing software professionally for over eight years, and unprofessionally
            for longer than that. I started with PHP and jQuery, fell in love with Python, and
            eventually found my home in systems programming with Go and Rust.
          </p>
          <p>
            These days I spend most of my time on backend infrastructure: distributed systems,
            developer tooling, and the invisible plumbing that makes everything else possible.
            I find the reliability/performance/simplicity tradeoff space endlessly interesting.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            <a href="mailto:hello@daedal.dev">hello@daedal.dev</a>. I&apos;m always happy to
          ...
          <p>
            ...
            and{' '}
            <a href="https://twitter.com/daedaldai" target="_blank" rel="noopener noreferrer">
              X/Twitter
            </a>
            .
          </p>
